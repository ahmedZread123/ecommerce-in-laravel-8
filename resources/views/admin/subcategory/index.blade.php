               ...
               <div class="row breadcrumbs-top">
                   <div class="breadcrumb-wrapper col-12">
                       <ol class="breadcrumb">
                           ...
                           <li class="breadcrumb-item active"> <a href="{{route('subcategory.index')}}">الاقسام الفرعية</a>
                           </li>
                       </ol>
                   </div>
               </div>
                                   ...
                                   <table
                                      ...
                                      @foreach ($sub as $sub)
                                               ...
                                               <tr>
                                                   ...
                                                   <td><img src="{{asset('image_subcategory/'.$sub->photo)}}" style="width:150px ; height:100px " alt="صورة"> </td>
                                                   ...
                                                   <td>
                                                       ...
                                                       <div class="btn-group" role="group"
                                                           ...
                                                           <a href="{{route('subcategory.active',$sub->id)}}"

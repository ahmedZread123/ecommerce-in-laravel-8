               ...
               <div class="row breadcrumbs-top">
                   <div class="breadcrumb-wrapper col-12">
                       <ol class="breadcrumb">
                           ...
                           <li class="breadcrumb-item active"> المتاجر الرئيسة
                           </li>
                       </ol>
                   </div>
               </div>
                               ...
                               <div class="card-body card-dashboard">
                                   <table
                                      ...
                                      @foreach ($vendor as $vendor)
                                               ...
                                               <tr>
                                                   <td>{{$vendor->name}} </td>
                                                   <td><img src="{{asset('image_vendor/'.$vendor->logo)}}" style="width:150px ; height:100px " alt="صورة"> </td>
                                                   <td> {{$vendor->mobile}}</td>
                                                   ...
                                                   <td>
                                                       ...
                                                       <div class="btn-group" role="group"
                                                           ...
                                                           <a href="{{route('vendor.active',$vendor->id)}}"

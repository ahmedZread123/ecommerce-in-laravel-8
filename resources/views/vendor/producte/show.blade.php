						...
						<div class="detail-media">
						 <div class="product-gallery">
							  <ul class="slides">
							    ...
							    <li data-thumb="{{asset('image_producte/'.$prod->photo)}}">
							    	<img src="{{asset('image_producte/'.$prod->photo)}}" alt="{{$prod->name}}" />
							    </li>
						...
						<div class="detail-info">
                            ...
                            {{-- <div class="quantity">
								...
								<div class="quantity-input">
									<input type="text" name="count" value="1" data-max="120" pattern="[0-9]*" >
							...
							<div class="wrap-butons">
								{{-- <a href="{{route('AddToCart',$prod->id)}}" class="btn add-to-cart">Add to Cart</a> --}}
							 <form action="{{route('AddToCart',$prod->id)}}" method="POST" >
								...
								<input type="hidden" name="producte_id" value="{{$prod->id}}">
					...
					<div class="wrap-show-advance-info-box style-1 box-in-site">
						...
						<div class="wrap-products">
							...
							<div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"3"},"1200":{"items":"5"}}' >
								...
								@foreach ($subcate->producte as $item)
									
								<div class="product product-style-2 equal-elem ">
									<div class="product-thumnail">
										<a href="{{route('show.producte',$item->id)}}" title="{{$item->name}}">
											<figure><img src="{{asset('image_producte/'.$item->photo)}}" width="214" height="214" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
										</a>

                        ...
                        <div class="box-content block_content">
                            ...
                            <div id="verticalmenu" class="verticalmenu" role="navigation">
                                ...
                                <ul class="menu level1">
                                    ...
                                    <li class="item  parent" ><a href="#" title="{{$cat->name}}">
                                        ...
                                        </i>{{$cat->name}}</a><span class="show-sub fa-active-sub"></span>
                                        <span class="menu-sub-title">Dell. HP, Macbook, Alienware and etc...</span>
                                        <div class="dropdown-menu" style="width:222px">

                                            <ul>
                                                @foreach ($cat->supcategory as $subcate)
                                                    @if ($subcate->translation_of == 0)
                                                        
                                            <li class="item " ><a href="#" title="Macbook Pro">{{$subcate->name}}</a></li>
                                            @endif

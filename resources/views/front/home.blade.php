                    ...
                    <div class="nov-row spacing-30 mt-15 col-lg-12 col-xs-12" ><div class="nov-row-wrap row">
                            ...
                            <div class="nov-productlist  productlist-rows     col-xl-8 col-lg-8 col-md-8 col-xs-12 col-md-12">
                                <div class="block block-product clearfix">
                                    ...
                                    <div class="block_content">
                                        <div id="productlist1693764381" class="product_list grid owl-carousel owl-theme multi-row" data-autoplay="false" data-autoplayTimeout="6000" data-loop="fales" data-margin="30" data-dots="false" data-nav="true" data-items="2" data-items_large="2" data-items_tablet="3" data-items_mobile="1" >
                                            @if (isset($prod))
                                                    
                                            
                                            <div class="item  text-center">
                                                @foreach ($prod as $pro)
                                                <div class="d-flex flex-wrap align-items-center product-miniature js-product-miniature item-row first_item" data-id-product="1" data-id-product-attribute="40" >
                                               
                                                   
                                                    <div class="col-12 col-w40 pl-0">
                                                        <div class="thumbnail-container">

                                                            <a href="{{route('show.producte',$pro->id)}}" class="thumbnail product-thumbnail two-image">
                                                                <img
                                                                    class="img-fluid image-cover"
                                                                    src = "{{asset('image_producte/'.$pro->photo)}}"
                                                                    alt = "صورة"
                                                    ...
                                                    <div class="col-12 col-w60 no-padding">
                                                        <div class="product-description">
                                                            <div class="product-groups">
                                                                ...
                                                                <a href="{{route('show.producte',$pro->id)}}">
                                                                  {{$pro->contact}}</a></div>
                                                                ...
                                                                <div class="product-group-price">
                                                                    ...
                                                                    <div class="product-price-and-shipping">
                                                                        ...
                                                                        <span itemprop="price" class="price">{{$pro->price}}$</span>

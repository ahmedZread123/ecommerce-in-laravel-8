					...
					<div class=" main-content-area">
						<div class="wrap-login-item ">
							<div class="register-form form-item ">
								<form class="form-stl" action="{{route('save_register')}}" name="frm-login" method="post" >
									@csrf
									...
									<fieldset class="wrap-input item-width-in-half ">
										...
										<input type="text" id="frm-reg-cfpass" name="password_con" placeholder="Confirm Password">
									</fieldset>
